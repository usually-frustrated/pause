...
| ----------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------- | ---------- |
| T1.1        | Define `action.yml` schema | 1. Create `action.yml` in `pause-org/action`. <br> 2. Map inputs to GitHub Action schema. <br> 3. Set `runs.using` to `node18` (Bun-compatible).                                                                                | User/Dev                                                                                                                         | [Milestone 1] | None             |
...
| T3.2        | GitHub Action test         | 1. Fork `pause-org/action` and push the workflow file. <br> 2. Trigger a run on `resume.json` change. <br> 3. Check logs for errors; validate artifact upload.                                                                  | User/Dev                                                                                                                         | [Milestone 8] | T3.1             |
